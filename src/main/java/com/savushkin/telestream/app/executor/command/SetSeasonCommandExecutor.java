...
@Service("/set_season")
@AllArgsConstructor
public class SetSeasonCommandExecutor implements CommandExecutor {
    ...
    public void updateStream(Stream stream) {
        stream.setSetNext(StreamField.SEASON);
    }
    ...
    public SendMessageDTO getSuccessMessage(long chatId, Stream stream) {
        return new SendMessageDTO(chatId, "Send season number");
    }
}
